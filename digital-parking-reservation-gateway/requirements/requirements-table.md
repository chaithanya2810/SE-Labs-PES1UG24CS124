...
|---|---|---|---|---|---|
| FR-001 | Functional | The system shall allow authenticated students to search available parking bays by campus zone and reserve a specific bay for a time window up to 24 hours in advance. | High | **Pass:** A valid reservation is created with a unique parking token and assigned bay. **Fail:** The system permits double-booking or a reservation beyond 24 hours. | Digital reservation is the core function of the gateway and prevents conflicts in parking allocation. |
